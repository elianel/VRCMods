...
namespace PlayerList
{
    internal class UI //this class looks like a mess lol
    {
        ...
        internal static void SelectUser(APIUser usr) => SelectUserInternal(usr).Start();
        private static IEnumerator SelectUserInternal(APIUser usr)
        {
            var inst = UserSelectionManager.prop_UserSelectionManager_0;
            _QMSelectMethod?.Invoke(inst, new object[] { usr });
        ...
        internal static IEnumerator Setup()
        {
            ...
            while ((leftWing = ui.transform.Find("Canvas_QuickMenu(Clone)/Container/Window/Wing_Left")) == null) yield return null;

            MainObject = GameObject.Instantiate(parent.gameObject, leftWing);
            ...
            //setup collider
            BoxCollider boxcol;
            while ((boxcol = leftWing.parent.GetComponent<BoxCollider>()) == null) yield return null;
        ...
        internal static MethodInfo _QMSelectMethod;
        internal static Dictionary<int, GameObject> playerList = new Dictionary<int, GameObject>();
